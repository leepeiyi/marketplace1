            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                <div className="flex items-start">
                  <svg
                    className="w-5 h-5 text-orange-600 mt-0.5 mr-2"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
                  ...
                  <div>
                    ...
                    <p className="text-sm text-orange-700">
                      Your job will be broadcast in stages: first to top-rated
                      providers nearby, then expanding to more providers over
                      time. You'll receive competitive bids to choose from.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-blue-700 space-y-1">
                      <li>
                        • <strong>0-5 minutes:</strong> Top-rated providers
                        nearby see your job
                      </li>
                      <li>
                        • <strong>5-15 minutes:</strong> Expanded to more
                        providers in wider area
                      </li>
                      <li>
                        • <strong>15+ minutes:</strong> All qualified providers
                        can bid
                      </li>
                      {useAcceptPrice && (
                        <li>
                          • <strong>Auto-hire:</strong> First bid ≤ $
                          {acceptPrice} gets the job
                        </li>
                      )}
                    </ul>
                  </div>
          ...
          {step === 3 && createdJob && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 mb-6">
                Your job is now being broadcast to qualified providers. You'll
                receive notifications as bids come in.
              </p>
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={() => {
                    handleClose();
                    // Navigate to bid tracking page
                    router.push(`/bids/${createdJob.id}`);
                  }}
