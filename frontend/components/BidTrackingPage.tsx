  ...
  return (
    <div className="p-6 hover:bg-gray-50 transition-colors">
            ...
            <div className="flex items-center gap-4 text-sm text-gray-600">
              <div className="flex items-center gap-1">
                ...
                <span className="text-gray-400">
                  ({bid.provider.provider.totalJobs} jobs)
                </span>
              </div>
      ...
      <div className="flex gap-3">
        ...
        <button
          onClick={() =>
            window.open(`tel:${bid.provider.provider.phone}`, "_self")
          }
        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            <p className="text-gray-700 mb-4">
              ...
              <strong>{bid.provider.provider.name}</strong>?
            </p>
...
export default function BidTrackingPage() {
  ...
  const confirmAcceptBid = async () => {
    ...
    try {
      const response = await fetch(
        `${API_URL}/api/bids/${selectedBid.id}/accept`,
        {
          method: "POST",
          headers: {
        ...
        sessionStorage.setItem(
          ...
          JSON.stringify({
            message:
              ...
              `Great! You've hired ${selectedBid.provider.provider.name} for $${selectedBid.price}. They'll contact you soon!`,
            type: "success",
          })
        );
  ...
  const sortedBids = [...bids].sort((a, b) => {
    switch (sortBy) {
      ...
      case "rating":
        return (
          b.provider.provider.averageRating - a.provider.provider.averageRating
        );
      case "time":
        return (
                ...
                {job.acceptPrice && (
                  <div>
                    ...
                    <div className="text-xs text-gray-500">
                      Any bid ≤ this amount will be auto-accepted
                    </div>
                  </div>
                )}
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow">
                ...
                {bids.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500">
                      Providers are being notified about your job. Bids
              ...
              <div className="divide-y">
                ...
                {sortedBids.length > 3 && (
                  <details className="px-6 py-4 cursor-pointer text-sm text-blue-600">
                    <summary className="hover:underline">
                      Show more bids
                    </summary>
                    <div className="divide-y mt-2">
                      {sortedBids.slice(3).map((bid, index) => (
                        <BidCard
                          key={bid.id}
                          bid={bid}
                          index={index + 3}
