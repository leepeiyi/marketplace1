...
describe('WebSocketService Unit Tests', () => {
  ...
  describe('handleMessage()', () => {
    ...
    it('should handle authenticate message', () => {
      const authenticateSpy = jest.spyOn(wsService, 'authenticateConnection').mockImplementation();
  ...
  describe('notifyCustomer()', () => {
    ...
    it('should handle disconnected customer gracefully', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Customer nonexistent not connected');
    });
  ...
  describe('notifyProvider()', () => {
    ...
    it('should handle disconnected provider gracefully', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Provider nonexistent not connected');
    });
  });
  ...
  describe('getStats()', () => {
    ...
    it('should return accurate connection statistics', () => {
      ...
      expect(stats).toEqual({
        ...
        customers: 2,
        providers: 1,
        connectedUsers: ['customer1', 'provider1', 'customer2']
      });
    });
  });
